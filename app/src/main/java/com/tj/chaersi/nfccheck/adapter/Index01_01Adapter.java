 ...
 */
public class Index01_01Adapter extends RecyclerView.Adapter<Index01_01Adapter.ItemViewHolder>{

    private Context context;
    private List<Index01_01.ListBean> residentArr;
    public Index01_01Adapter(Context context,List<Index01_01.ListBean> residentArr){
