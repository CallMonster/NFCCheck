 ...
 */
public class ResidentCheckAdapter extends RecyclerView.Adapter<ResidentCheckAdapter.ItemViewHolder>{

    private Context context;
    private ArrayList<Resident01.ListBean> pointArr;
    private HashMap<Integer,Boolean> isChoosed;
    public ResidentCheckAdapter(Context context,ArrayList<Resident01.ListBean> pointArr) {
    ...
    public void onBindViewHolder(ItemViewHolder holder, int position) {
        Resident01.ListBean item=pointArr.get(position);
     ...
     * @param pointArr
     */
    public void notifyItemChoosed(List<Resident01.ListBean> pointArr){
        this.pointArr.clear();
     ...
     * @return
     */
    public Resident01.ListBean getChooseItem(){
        int tempPosition=-1;
        for(int i=0;i< this.pointArr.size();i++){
            if(isChoosed.get(i)){
                tempPosition=i;
        ...
        if(tempPosition==-1){
            ...
            return pointArr.get(tempPosition);
        }
    }
