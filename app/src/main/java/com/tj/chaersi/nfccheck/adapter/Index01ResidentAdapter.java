 ...
 */
public class Index01ResidentAdapter extends RecyclerView.Adapter<Index01ResidentAdapter.ItemViewHolder> {

    private Context context;
    private List<Index01ResidentModel.ListBean> residentArr;

    public Index01ResidentAdapter(Context context, List<Index01ResidentModel.ListBean> residentArr) {
    ...
    public ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_resident, null);
    ...
    public void onBindViewHolder(ItemViewHolder holder, int position) {
        ...
        holder.fixState.setText(residentArr.get(position).getLabelnum()+"-"+residentArr.get(position).getNum());
